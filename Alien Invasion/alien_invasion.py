...
class AlienInvasion:
    """Overall calss to manage game assets and behaviour"""
    ...
    def _update_bullets(self):
        """Update possition of the bullets and get rid of old bullets."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Remove any bullets and aliensthat have collided
    ...
    def _update_aliens(self):
        """Check if the fleet is at an edge, then update the position of all the aliens in the fleet."""
